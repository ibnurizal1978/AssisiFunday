...
jQuery(document).ready(function ($) {
    ...
    $('#delivery_leadtime').change(function(e){
        const godeg = $('#delivery_leadtime').val();
         console.log(godeg);

         tempdate = new Date();
         tempdate.setDate(tempdate.getDate() + godeg);
         da = new Date(tempdate);

         if(godeg){
           $("#loading").html('<br/><b style=color:#ff0000>Loading available date...</b>');
           $.ajax({
               type:'POST',
               url:'shop_leadtime',
               data:'t='+godeg+'&id='+<?php echo $id ?>,
               //data:'t='+godeg,
  ...
  <div class="content">
    ...
    <div class="block table-responsive">
      <div class="block-header block-header-default">
        <h3 class="block-title">New Shop</h3><p id="due_date"></p>
      </div>
