  ...
  <div class="content">
    ...
    <div class="block table-responsive">
      <div class="block-header block-header-default">
        <h3 class="block-title">New Shop</h3>
      </div>
        ...
        <div class="card-body">
          ...
          <input type="hidden" name="id" value="<?php echo Encryption::encode($row["shop_id"]) ?>" />
            ...
            <!--<div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                    <label class="bmd-label-floating">Main Category</label>
                    <select class="form-control" name="category_id[]" multiple="multiple">
                        <option value="Asia" <?php if(@$cat_id[0]=='Asia' || @$cat_id[1]=='Asia' || @$cat_id[2]=='Asia') { echo 'selected'; } ?>>Asia</option>
                        <option value="America" <?php if(@$cat_id[0]=='America' || @$cat_id[1]=='America' || @$cat_id[2]=='America') { echo 'selected'; } ?>>America</option>
                        <option value="Europe" <?php if(@$cat_id[0]=='Europe' || @$cat_id[1]=='Europe' || @$cat_id[2]=='Europe') { echo 'selected'; } ?>>Europe</option>
                    </select>
                    </div>
                </div>
            </div>-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="website_link" value="<?php echo $row['website_link'] ?>" />
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                    <b>Pickup Times</b><br/>Please set it from menu "outlet"
            ...
            <div class="row">
                <div class="col-md-6">
                    <b>Is Halal?</b>
                    <select class="form-control" name="is_halal">
                        <option value="">Select options</option>
                        <option value="1" <?php if(@$row['is_halal']=='1') { echo 'selected'; } ?>>Yes</option>
                        <option value="0" <?php if(@$row['is_halal']=='0') { echo 'selected'; } ?>>No</option>
                    </select>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <b>Pickup Location (separated by comma)</b><br/>Please set it from menu "outlet"
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="is_highlight">
                      <option value="1" <?php if(@$row['is_highlight']=='1') { echo 'selected'; } ?>>Yes</option>
                      <option value="0" <?php if(@$row['is_highlight']=='0') { echo 'selected'; } ?>>No</option>
                    </select>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                  <b>Priority</b>
                  <input type="text" class="form-control" name="is_priority" value="<?php echo $row['is_priority'] ?>"></p>
                  </div>
                </div>
            </div>
            <!--<div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                  <b>Facebook Live URL</b>
                  <input type="text" class="form-control" name="fb_live_url" value="<?php echo $row['fb_live_url'] ?>"></p>
                  </div>
                </div>
            </div>-->
            <div class="row">
              <div class="col-md-12">
                  <b>Is Eco Merchant?</b>
                  <select class="form-control" name="is_eco_merchant">
                    <option value="1" <?php if(@$row['is_eco_merchant']=='1') { echo 'selected'; } ?>>Yes</option>
                    <option value="0" <?php if(@$row['is_eco_merchant']=='0') { echo 'selected'; } ?>>No</option>
                  </select>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea rows="10" id="shopLocation" name="shop_description"><?php echo $row['shop_description'] ?></textarea>
                </div>
              </div>
            </div>
            <br/><br/>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea rows="10" id="shopLocation" name="shop_location"><?php echo $row['location'] ?></textarea>
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <?php if ($row['cover_image'] <> '') { ?>Existing image: <a target="_blank" href="<?php echo $image_path.'cover/'.$row['cover_image']; ?>" >view</a><?php } ?>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="bmd-label-floating">Upload Shop Icon (Image only accept image resolution of max 300px Height)</label>
                  <input type="file" id="icon" name="icon" class="form-control" style="padding: 5px 5px 5px 5px;" accept="image/jpeg,image/png" onchange="loadIconImage(event)" />
                  <ul id="icon_placeholder" style="list-style: none;"></ul>
                  <input type="hidden" name="shop_icon" value="<?php echo $row['shop_icon'] ?>" />
                  <?php if ($row['shop_icon'] <> '') { ?>Existing image: <a target="_blank" href="<?php echo $image_path.'icon/'.$row['shop_icon']; ?>" >view</a><?php } ?>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="bmd-label-floating">Upload Shop Image (Image only accept image resolution of 300px Width x 300px Height)</label>
                        <input type="file" id="icon2" name="icon2" class="form-control" style="padding: 5px 5px 5px 5px;" accept="image/jpeg,image/png" onchange="loadIconImage2(event)" />
                        <ul id="icon_placeholder2" style="list-style: none;"></ul>
                        <input type="hidden" name="shop_image" value="<?php echo $row['shop_image'] ?>" />
                        <?php if ($row['shop_image'] <> '') { ?>Existing image: <a target="_blank" href="<?php echo $image_path.'image/'.$row['shop_image']; ?>" >view</a><?php } ?>
                    </div>
                </div>
            </div>
...
$(document).ready(function(){
  ...
  $('#datepicker').datepicker({
      startDate: `+${$("#delivery_leadtime").val() || "0"}d`,
      multidate: true,
      format: "yyyy-mm-dd",
  ...
  $('#datepicker2').datepicker({
      startDate: `+${$("#pickup_leadtime").val() || "0"}d`,
      multidate: true,
      format: "yyyy-mm-dd",
      datesDisabled: ['31/08/2017'],
      language: 'en'
