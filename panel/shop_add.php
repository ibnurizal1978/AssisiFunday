...
if($shop_name == "" || $order_index == "") {
  echo "<script>";
  echo "alert('Please fill name, category, delivery time, pickup time and order index'); window.location.href=history.back()";
  echo "</script>";
  exit();
}
