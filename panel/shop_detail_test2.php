...
$(document).ready(function(){
  ...
  // Get selected dates
  let deliveryDates = $('#datepicker').val().split(",")
  let newDeliveryDates = deliveryDates.map(date => new Date(date))
  console.log(newDeliveryDates)
