	...
	for(var i = 0, file; file = files[i]; i++)
	{
				...
				|| event.target.files[i].name.indexOf(".jpeg") > -1)
		{
			...
			imageElement.onload = function()
			{
				...
				{
					$("#icon").val("");
					alert("Image only accept image resolution of 300px (Height)");
				}
				else
				{
				var liElement = document.createElement("LI");
  ...
  <div class="content">
    ...
    <div class="block table-responsive">
      ...
      <div class="block-content">
        ...
        <div class="card-body">
          <form action="shop_add" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                  <b>Priority</b>
                  <input type="text" class="form-control" name="is_priority" value="0"></p>
                  </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="fb_live_url" /></p>
                  </div>
                </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea rows="10" id="shopLocation" name="shop_description"></textarea>
                </div>
              </div>
            </div>
            <br/><br/>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea rows="10" id="shopLocation" name="shop_location"></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="bmd-label-floating">Upload Shop Icon (Image only accept image resolution max 300px Height)</label>
