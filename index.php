            ...
            <main id="main-container">
                ...
                <div class="bg-image" style="background-image: url('assets/img/bg-login.jpg');">
                    <div class="hero-static content content-full bg-white-op-90 invisible" data-toggle="appear" data-class="animated fadeIn">
                        <!-- Avatar -->
                        <div class="py-30 px-5 text-center" style="margin-top: 50px">
                            <a class="link-effect text-pulse font-w700">
                                <i class="si si-fire"></i>
                                <span class="font-size-xl text-pulse-dark">Assisi CMS</span> <span class="font-size-xl text-success">Dashboard</span>
                            </a>
                            <h2 class="h4 font-w400 text-muted mb-30">Please type your username and password</h2>
                            <img src="assets/img/logo.png" alt="">
                        </div>
                        <!-- END Avatar -->

                        <!-- Unlock Content -->
                        <div class="row justify-content-center px-5" style="margin-top: 100px">
